                                        ...
                                        <div class="row justify-content-end mb-3">
                                            <div class="col-lg-5 ">
                                                ...
                                                <input style="width:100px;" type="file" class="form-control offset-4"
                                                    name="fimg" id="fimg" value="<?php echo $fimg_old ?>" required>
                                            ...
                                            <div class="col-lg-5 ">
                                                ...
                                                <input style="width:100px;" type="file" class="form-control offset-5"
                                                    name="bimg" id="bimg" value="<?php echo $bimg_old ?>" required>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="model" id="model"
                                                    value="<?php echo $model_old ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="color" id="color"
                                                    value="<?php echo $color_old ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="ram" id="ram"
                                                    value="<?php echo $ram_old ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <div class="row mb-3">
                                            <label for="fcam"
                                                ...
                                                Cam</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="fcam" id="fcam"
                                                    value="<?php echo $fcam_old ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="rcam" id="rcam"
                                                    value="<?php echo $rcam_old ?>" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="price"
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="price" id="price"
                                                    value="<?php echo $price_old ?>" required>
                                            </div>
                                        </div>
