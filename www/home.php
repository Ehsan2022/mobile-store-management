                      ...
                      <div class="card info-card">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center">
                            <div style="background-color:#4b434a55;" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-xxl-3 col-md-4 col-6">
                      <div class="card info-card ">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center">
                            <div style='background-color:#43f62755;' class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-xxl-3 col-md-4 col-6">
                      ...
                      <div class="card info-card">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center">
                            <div style='background-color:#e219b755;' class="card-icon rounded-circle d-flex align-items-center justify-content-center">
